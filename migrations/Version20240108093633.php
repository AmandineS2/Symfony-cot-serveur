 ...
 */
final class Version20240108093633 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD image VARCHAR(255) NOT NULL, DROP id, DROP PRIMARY KEY, ADD PRIMARY KEY (image)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD id INT AUTO_INCREMENT NOT NULL, DROP image, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    }
}
